...
12. **How do visibility modifiers work in Kotlin classes?**n+    - `public` is default and accessible everywhere.
...
17. **What are `sealed` classes best used for in Kotlin interview answers?**n+    - Representing finite states, result types, and event hierarchies.
